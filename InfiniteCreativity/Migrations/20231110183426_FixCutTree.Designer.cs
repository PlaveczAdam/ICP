...
namespace InfiniteCreativity.Migrations
{
    ...
    [Migration("20231110183426_FixCutTree")]
    partial class FixCutTree
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.CoreNS.Minion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("Minion");

                    b.UseTphMappingStrategy();
                });

            modelBuilder.Entity("InfiniteCreativity.Models.CoreNS.MinionBlueprint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MinionBlueprint");

                    b.HasData(
                        new
                        {
                            Id = new Guid("c46db327-c6c5-4ec2-b093-f5c7cc3bca07"),
                            SkillId = new Guid("0d97f399-4303-43ab-af02-eab16fb5be04"),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.CoreNS.Skill", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("0d97f399-4303-43ab-af02-eab16fb5be04"),
                            AbilityGaugeCost = 0,
                            Cooldown = 0,
                            Damage = 0.0,
                            Description = "n",
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.GameNS.GameCharacter", b =>
                {
                    ...
                    b.Property<int>("TreeCuttingLeft")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.CoreNS.Taunt", b =>
                {
                    b.HasBaseType("InfiniteCreativity.Models.CoreNS.Condition");
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.CoreNS.BB", b =>
                {
                    b.HasBaseType("InfiniteCreativity.Models.CoreNS.Minion");

                    b.HasDiscriminator().HasValue("BB");
                });
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.CoreNS.BattleParticipant", b =>
                {
                    ...
                    b.HasOne("InfiniteCreativity.Models.CoreNS.Character", "Character")
                        .WithOne("BattleParticipant")
                        .HasForeignKey("InfiniteCreativity.Models.CoreNS.BattleParticipant", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("InfiniteCreativity.Models.GameNS.Enemys.Enemy", "Enemy")
                        .WithOne("BattleParticipant")
                        .HasForeignKey("InfiniteCreativity.Models.CoreNS.BattleParticipant", "EnemyId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("InfiniteCreativity.Models.CoreNS.Minion", "Minion")
                        .WithOne("BattleParticipant")
                        .HasForeignKey("InfiniteCreativity.Models.CoreNS.BattleParticipant", "MinionId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("InfiniteCreativity.Models.GameNS.Battle", b =>
                {
                    b.HasOne("InfiniteCreativity.Models.CoreNS.BattleParticipant", "NextInTurn")
                        .WithOne()
                        .HasForeignKey("InfiniteCreativity.Models.GameNS.Battle", "NextInTurnId")
                        .OnDelete(DeleteBehavior.SetNull);

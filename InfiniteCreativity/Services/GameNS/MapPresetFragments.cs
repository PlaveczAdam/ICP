...
namespace InfiniteCreativity.Services.GameNS
{
    public class MapPresetFragments
    {
        ...
        public MapFragmentPresetDTO Preset3 = JsonConvert.DeserializeObject<MapFragmentPresetDTO>("{\"map\":[[{\"row\":0,\"col\":0,\"content\":\"empty\"},{\"row\":0,\"col\":1,\"content\":\"empty\"},{\"row\":0,\"col\":2,\"content\":\"empty\"}],[{\"row\":1,\"col\":0,\"content\":\"empty\"},{\"row\":1,\"col\":1,\"content\":\"city\"},{\"row\":1,\"col\":2,\"content\":\"empty\"}],[{\"row\":2,\"col\":0,\"content\":\"empty\"},{\"row\":2,\"col\":1,\"content\":\"empty\"},{\"row\":2,\"col\":2,\"content\":\"empty\"}]]}");
